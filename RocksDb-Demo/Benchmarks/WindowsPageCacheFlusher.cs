...
static class WindowsPageCacheFlusher
{
    [DllImport("ntdll.dll")]
    ...
    public static void Flush()
    {
        ...
        try
        {
            ...
            uint status = NtSetSystemInformation(0x0050, buffer, sizeof(int));
            ...
            if (_available is null)
            {
                ...
                if (!_available.Value)
                {
                    string elevationNote = IsProcessElevated()
    ...
    private static void TryEnableProfilePrivilege()
    {
        ...
        try
        {
            LookupPrivilegeValue(null, "SeProfileSingleProcessPrivilege", out long luid);
    ...
    private static bool IsProcessElevated()
    {
        ...
        try
        {
            GetTokenInformation(token, 20 /* TokenElevation */, out int elevation, sizeof(int), out _);
            return elevation != 0;
        }
        finally
        {
